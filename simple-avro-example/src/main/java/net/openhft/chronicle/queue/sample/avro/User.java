...
public class User extends org.apache.avro.specific.SpecificRecordBase
	...
	private static final long serialVersionUID = 5909717787982197531L;
	public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse(
			"{\"type\":\"record\",\"name\":\"User\",\"namespace\":\"net.openhft.chronicle.queue.sample.avro\",\"fields\":[{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"favorite_number\",\"type\":\"int\",\"default\":0},{\"name\":\"favorite_color\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null}]}");
	...
	public void put(int field$, java.lang.Object value$) {
		...
		case 1:
			...
			break;
		case 2:
			favorite_color = (java.lang.String) value$;
			break;
		default:
			throw new org.apache.avro.AvroRuntimeException("Bad index");
		}
	 ...
	 */
	public static net.openhft.chronicle.queue.sample.avro.User.Builder newBuilder() {
		return new net.openhft.chronicle.queue.sample.avro.User.Builder();
	}
	 ...
	 */
	public static net.openhft.chronicle.queue.sample.avro.User.Builder newBuilder(
			net.openhft.chronicle.queue.sample.avro.User.Builder other) {
		if (other == null) {
			return new net.openhft.chronicle.queue.sample.avro.User.Builder();
		} else {
			return new net.openhft.chronicle.queue.sample.avro.User.Builder(other);
		}
	}
	 ...
	 */
	public static net.openhft.chronicle.queue.sample.avro.User.Builder newBuilder(
			net.openhft.chronicle.queue.sample.avro.User other) {
		if (other == null) {
			return new net.openhft.chronicle.queue.sample.avro.User.Builder();
		} else {
			return new net.openhft.chronicle.queue.sample.avro.User.Builder(other);
	...
	public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<User>
		 ...
		 * @param other The existing Builder to copy.
		 */
		private Builder(net.openhft.chronicle.queue.sample.avro.User.Builder other) {
			super(other);
		 ...
		 * @param other The existing instance to copy.
		 */
		private Builder(net.openhft.chronicle.queue.sample.avro.User other) {
			super(SCHEMA$);
			if (isValidValue(fields()[0], other.name)) {
				this.name = data().deepCopy(fields()[0].schema(), other.name);
		 ...
		 * @return This builder.
		 */
		public net.openhft.chronicle.queue.sample.avro.User.Builder setName(java.lang.String value) {
		 ...
		 * @return This builder.
		 */
		public net.openhft.chronicle.queue.sample.avro.User.Builder clearName() {
			name = null;
		 ...
		 * @return This builder.
		 */
		public net.openhft.chronicle.queue.sample.avro.User.Builder setFavoriteNumber(int value) {
		 ...
		 * @return This builder.
		 */
		public net.openhft.chronicle.queue.sample.avro.User.Builder clearFavoriteNumber() {
		 ...
		 * @return This builder.
		 */
		public net.openhft.chronicle.queue.sample.avro.User.Builder setFavoriteColor(java.lang.String value) {
		 ...
		 * @return This builder.
		 */
		public net.openhft.chronicle.queue.sample.avro.User.Builder clearFavoriteColor() {
			favorite_color = null;
